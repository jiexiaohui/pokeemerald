...
#define FLAG_REPEL_CHARM_ACTIVE    0x20 // Toggles infinite repel
#define FLAG_QUICK_START_PENDING    0x21 // Nuzlocke QoL: set on a fresh save, cleared once Route101's quick-start script runs
