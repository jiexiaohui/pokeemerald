...
extern const u32 gTypeIcon_Normal[];
extern const u32 gTypeIcon_Fighting[];
extern const u32 gTypeIcon_Flying[];
extern const u32 gTypeIcon_Poison[];
extern const u32 gTypeIcon_Ground[];
extern const u32 gTypeIcon_Rock[];
extern const u32 gTypeIcon_Bug[];
extern const u32 gTypeIcon_Ghost[];
extern const u32 gTypeIcon_Steel[];
extern const u32 gTypeIcon_Fire[];
extern const u32 gTypeIcon_Water[];
extern const u32 gTypeIcon_Grass[];
extern const u32 gTypeIcon_Electric[];
extern const u32 gTypeIcon_Psychic[];
extern const u32 gTypeIcon_Ice[];
extern const u32 gTypeIcon_Dragon[];
extern const u32 gTypeIcon_Dark[];

extern const u16 gTypeIconPal_Normal[];
extern const u16 gTypeIconPal_Fighting[];
extern const u16 gTypeIconPal_Flying[];
extern const u16 gTypeIconPal_Poison[];
extern const u16 gTypeIconPal_Ground[];
extern const u16 gTypeIconPal_Rock[];
extern const u16 gTypeIconPal_Bug[];
extern const u16 gTypeIconPal_Ghost[];
extern const u16 gTypeIconPal_Steel[];
extern const u16 gTypeIconPal_Fire[];
extern const u16 gTypeIconPal_Water[];
extern const u16 gTypeIconPal_Grass[];
extern const u16 gTypeIconPal_Electric[];
extern const u16 gTypeIconPal_Psychic[];
extern const u16 gTypeIconPal_Ice[];
extern const u16 gTypeIconPal_Dragon[];
extern const u16 gTypeIconPal_Dark[];
