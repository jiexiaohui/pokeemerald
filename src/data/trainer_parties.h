...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_DREAM_EATER, MOVE_DESTINY_BOND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AURORA_BEAM, MOVE_REST, MOVE_SHEER_COLD, MOVE_TAKE_DOWN}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_RAIN_DANCE, MOVE_SAFEGUARD, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERPOWER, MOVE_ANCIENT_POWER, MOVE_AMNESIA, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LUSTER_PURGE, MOVE_PSYCHIC, MOVE_RECOVER, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MIST_BALL, MOVE_PSYCHIC, MOVE_RECOVER, MOVE_CHARM}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_ROCK_TOMB, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY, MOVE_SUNNY_DAY, MOVE_WILL_O_WISP}
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EMBER, MOVE_LEER, MOVE_SMOG, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 26,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MAGNITUDE, MOVE_TACKLE, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_FACADE}
    },
    {
    .iv = 200,
    .lvl = 27,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK, MOVE_WING_ATTACK, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_WATER_PULSE}
    },
    {
    .iv = 200,
    .lvl = 41,
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_RAGE, MOVE_TWISTER, MOVE_HYDRO_PUMP, MOVE_WATER_PULSE}
    },
    {
    .iv = 200,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAKE_DOWN, MOVE_RAPID_SPIN, MOVE_SPIKES, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SANDSTORM, MOVE_SLAM, MOVE_IRON_TAIL, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_FUTURE_SIGHT, MOVE_COSMIC_POWER, MOVE_DOOM_DESIRE}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PURSUIT, MOVE_PSYCHIC, MOVE_IRON_DEFENSE, MOVE_METEOR_MASH}
    }
};
